...
import { OAUTH_INIT_STEPS, OAUTH_RETURN_STEPS } from "@/components/ui/loaders/TerminalLoader/constants"
...
export function LoginModal() {
    ...
    const [restoredProvider, setRestoredProvider] =
        useState<OAuthProvider | null>(null)
    const [failedProvider, setFailedProvider] = useState<OAuthProvider | null>(
        null,
    )
            ...
            <div className='-m-4 overflow-hidden border border-line-c bg-bg-3/5'>
                ...
                >
                    ...
                    <div className='mb-8 text-center'>
                        ...
                        <p
                            id={AUTH_DESC_ID}
                            className='text-[12px] tracking-tight text-t-3 font-jetbrains'
                        >
...
const LoginOptions = memo(function LoginOptions({
    ...
    return (
        ...
        >
            {options.map((option) => {
                const isFailedProvider =
                    failedProvider !== null && option.key === failedProvider
                ...
                return (
                    <button
                        ...
                        title={
                            isFailedProvider
                                ? "Use Retry above to try this provider again"
                                : undefined
                        }
