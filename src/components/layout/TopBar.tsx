  ...
  return (
    <header className="bg-bg-1 border-b border-line-c h-12 flex items-center px-sp7 flex-shrink-0">
      ...
      <div className="flex items-center gap-sp4 flex-shrink-0">
        {/* Deposit */}
        <button className="px-[11px] py-[5px] bg-[rgba(205,189,112,0.15)] border border-line-g rounded-r4 text-button text-g-3 whitespace-nowrap cursor-pointer hover:bg-[rgba(205,189,112,0.22)] transition-colors">
          + Deposit
        </button>
        ...
        {/* Avatar */}
        <div className="w-[26px] h-[26px] rounded-full bg-[rgba(205,189,112,0.2)] border border-line-g flex items-center justify-center text-[10px] font-[700] text-g-3 select-none">
          {userInitials}
        </div>
      </div>
    </header>
