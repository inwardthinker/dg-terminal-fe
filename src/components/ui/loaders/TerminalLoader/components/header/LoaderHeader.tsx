            ...
            <div className="flex items-center justify-between border-b border-[#2a2a22] bg-[#161610] px-[14px] py-[10px]">
                <div className="flex items-center gap-[10px]">
                    ...
                    <div className="flex items-center uppercase">
                        <span className="font-jetbrains ml-2 flex items-center gap-0.5 uppercase text-[10px] tracking-[0.16em] text-t-3/80">{title}</span>
                        <DotSeparator size={1} className="bg-t-3/50" />
                        <span className="font-jetbrains ml-2 flex items-center gap-0.5 uppercase text-[10px] tracking-[0.16em] text-t-3/80">{subtitle}</span>
                    </div>
                </div>
