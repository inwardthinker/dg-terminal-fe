  ...
  return (
    <div className="w-full rounded-r7 border border-line-c bg-bg-1 overflow-x-hidden">
      <div
        ...
        className={
          shouldVirtualize ? 'max-h-[calc(100vh-280px)] overflow-y-auto scroll-smooth' : undefined
        }
      >
        <div className="text-sm max-sm:text-[13px]">
          <div
            className={`sticky top-0 z-10 grid ${POSITION_TABLE_GRID_COLUMNS} items-center border-b border-line-c bg-bg-1 text-support ${POSITION_TABLE_GRID_COLUMNS_MOBILE} max-sm:text-[12px]`}
          >
      ...
      <div className="flex justify-between max-sm:hidden">
        ...
        <Link
          href="/portfolio"
          className="text-g-3! text-xs! flex items-center px-2 py-2 space-x-1 max-sm:self-start"
        >
