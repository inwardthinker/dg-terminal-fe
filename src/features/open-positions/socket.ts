...
export function resolvePositionsPriceSocketUserAddress(
  explicitUserAddress?: string,
): string | null {
  const rawAddress =
    explicitUserAddress ?? process.env.NEXT_PUBLIC_POSITIONS_SOCKET_USER_ADDRESS ?? null
